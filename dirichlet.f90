!
!  This file contains a primitive fortran code for solving the Dirichlet
...
!  angle.   It operates by discretizing the integral equation
!
!    (1/2 I + K ) \sigma =  f,
!
!  where K is the double layer operator, and inverting the resulting
!  linear system using an LAPACK routine.
!
...
!
!  When it is not set, the method used is a standard Nystrom method.  The
!  matrix A formed in this case is related to that formed when ifscale=1
!  via conjugation with a diagonal matrix.
!

module dirichlet_subroutines
